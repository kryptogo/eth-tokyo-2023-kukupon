...
export interface WhitelistingPaymasterInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "AddressAddedToWhitelist(address,uint256)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "AddressAddedToWhitelist"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
}

export interface AddressAddedToWhitelistEventObject {
  addr: string;
  sponsoredGas: BigNumber;
}
export type AddressAddedToWhitelistEvent = TypedEvent<
  [string, BigNumber],
  AddressAddedToWhitelistEventObject
>;

export type AddressAddedToWhitelistEventFilter =
  TypedEventFilter<AddressAddedToWhitelistEvent>;
...
export interface WhitelistingPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WhitelistingPaymasterInterface;
  ...
  functions: {
    ...
    userDetails(
      ...
      [boolean, BigNumber] & { isWhitelisted: boolean; remainingGas: BigNumber }
    >;
  ...
  filters: {
    "AddressAddedToWhitelist(address,uint256)"(
      addr?: PromiseOrValue<string> | null,
      sponsoredGas?: null
    ): AddressAddedToWhitelistEventFilter;
